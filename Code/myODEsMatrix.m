function dydt = myODEsMatrix(~, y)
    ...
    % ODE system matrices
    A = [
        -lambda_Nd - lambda_N - lambda_F*y(5),       0,                      0,                      0,                   -lambda_F*y(1);
         lambda_iBeta,                               -d_Ai_beta,             0,                      0,                    0;
         lambda_F*y(5),                               0,                     -d_Fi,                    0,                    0;
         0,                                           0,                      0,                     -d_Fo,                 lambda_F*y(1);
         lambda_N,                                    0,                      0,                      0,                  -d_tau;
        -lambda_tau,                                  0,                      0,                      0,                    0;
         0,                                          0,                      0,                      0,                  -d_A;
         0,                                          0,                      0,                      0,                    0
    ];
    ...
    B = [
        -lambda_Nd - lambda_N*y(1) + d_NF*y(8)*(1 - exp(-beta_M2*y(7))), 
         lambda_iBeta, 
         0,
         0,
         lambda_tau*R0*(1 - exp(-beta_M1*y(6))),
        -lambda_A_beta_o_M*y(6)*y(8) - lambda_tau*y(5) + d_tau*y(5),
         lambda_MA*(1 - exp(-theta*beta_M1*y(7))),
         lambda_MA*exp(-theta*beta_M2*y(7))
    ];

    % Matrix form of ODE system
    dydt = A * y + B;
end
